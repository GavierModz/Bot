...
require('./wabot.js')
nocache('../wabot.js', module => console.log(color('[ CHANGE ]', 'green'), color(`'${module}'`, 'green'), 'Updated'))
require('./index.js')
...
require('./wabot')(XeonBotInc, m, chatUpdate, store)
} catch (err) {
console.log(err)}})
